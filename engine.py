...
def calculate_radar(df, mode="DAY", trend_direction=0):
    ...
    if data:
        ...
        prob *= (1+0.1*E*10000)           # Energia
        prob *= (1+0.5*sigma)             # Desvio
